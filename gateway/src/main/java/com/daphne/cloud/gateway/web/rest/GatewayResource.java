package com.daphne.cloud.gateway.web.rest;

import com.daphne.cloud.gateway.web.rest.vm.RouteVM;
...
public class GatewayResource {
    ...
    @Value(value = "${info.master}")
    private String testStr="no found";
    ...
    public ResponseEntity<List<RouteVM>> activeRoutes() {
        System.out.println(env.getProperty("info.master"));
